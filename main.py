...
def handle_message(update: Update, _: CallbackContext):
    ...
    if 'бухгалтерию' in question or 'бухгалтерия' in question or 'бухгалтерский' in question or 'финансы' in question or 'зп                                                                                ' in question or 'зарплата' in question or 'документы' in question:
        answer = "Бухгалтерия отвечает за учет и анализ финансовых операций компании. Если у вас возникли вопросы по бухгалт                                                                                ерии, вы можете обратиться к своему руководителю или бухгалтеру компании."
    elif 'привет' in question or 'здравствуйте' in question or 'добрый день' in question or 'добрый вечер' in question or 'д                                                                                оброе утро' in question:
...
if __name__ == '__main__':
    main()
(telegranchat) root@telegram:~# ^C
(telegranchat) root@telegram:~# nano mine.py
(telegranchat) root@telegram:~# python mine.py
2023-04-18 10:45:44,182 - apscheduler.scheduler - INFO - Scheduler started
^C2023-04-18 11:14:59,051 - telegram.ext.updater - INFO - Received signal 2 (SIGINT), stopping...
2023-04-18 11:14:59,051 - apscheduler.scheduler - INFO - Scheduler has been shut down
^C2023-04-18 11:14:59,678 - telegram.ext.updater - WARNING - Exiting immediately!
(telegranchat) root@telegram:~# ^C
(telegranchat) root@telegram:~# cat mine.py
import logging
import telegram
from telegram import Update
from telegram.ext import Updater, CommandHandler, MessageHandler, Filters, CallbackContext
